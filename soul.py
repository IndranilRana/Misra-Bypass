...
TOKEN = '7290879020:AAFLuKaLH8YEclFFTJtr4cFfh_IKh9zlmco'
...
FORWARD_CHANNEL_ID = -1002167442259
CHANNEL_ID = -1002167442259
error_channel_id = -1002167442259
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/BLACKHOLEVIPGROUP*", parse_mode='Markdown')
